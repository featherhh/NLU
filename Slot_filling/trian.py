...
from Slot_filling.model.BiLSTM_CRF import *
from Slot_filling.utils.data_loader import *
...
def model2train():
    ...
    for epoch in range(conf.epochs):
        ...
        if f1 > f1_score:
            f1_score = f1
            torch.save(model.state_dict(), r'F:\ai\第八阶段-nlp2\完整代码\MedicalKB\NLU\Slot_filling\save_model/bilstm_crf_cuda.pth')
            print(report)
    end_time = time.time()
